...
type Shared_Auxiliary_599 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_599[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_599;
    }
  | {
      spans:
        | {
            some: Shared_Auxiliary_617;
          }
        | {
            none: Shared_Auxiliary_617;
          };
    }
  | {
      scores:
...
type Shared_Auxiliary_617 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_617[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_617;
    };

type Shared_Auxiliary_1157 =
  | {
      op: 'eq' | 'ne' | 'lt' | 'lte' | 'gt' | 'gte';
      left:
        | {
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_1157[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_1157;
    };

type Shared_Auxiliary_1297 = {
  id?: string | undefined;
  name: string;
  type: 'file' | 'folder';
  content?: string | undefined;
  children?: Shared_Auxiliary_1297[] | undefined;
};
...
type Shared_Type_112 = {
  ...
  metadata?:
    ...
    | undefined;
  steps: Shared_Type_107;
  predicates: Shared_Auxiliary_1157[];
};
...
type Shared_Type_113 = {
  ...
  predicate: Shared_Auxiliary_1157;
};
...
type Shared_Type_127 = {
  ...
  files?: Shared_Auxiliary_1297[] | undefined;
...
export type PostMemoryThreadsThreadIdBranch_Response = Shared_Type_67;
...
export type GetMemoryThreadsThreadIdParent_Response = Shared_Type_63 | null;
...
export type PostObservabilityTracesQuery_Body = {
  ...
  where?: Shared_Auxiliary_599 | undefined;
  group?:
    | {
        by: ['threadId'];
      }
...
export type PatchStoredSkillsStoredSkillId_Body = {
  ...
  /** Full file tree structure for the skill */
  files?: (Shared_Auxiliary_1297[] | undefined) | undefined;
  /** Additional metadata for the skill */
  metadata?:
    | (
        | {
